...
namespace Match3Game
{
    public class Gem : MonoBehaviour
    {
        ...
        public ActivationSource? activationSource { get; private set; }
        public Gem triggeredBy { get; private set; }  // 記錄是被哪個寶石觸發的
        public int triggerChainDepth { get; private set; }  // 記錄在連鎖中的層級
        public void SetActivationInfo(ActivationSource source, Gem trigger = null)
        {
            this.activationSource = source;
            this.triggeredBy = trigger;
            this.triggerChainDepth = trigger?.triggerChainDepth + 1 ?? 0;
        }
        public void SetActivationSource(ActivationSource source)
        {
            this.activationSource = source;
        }
